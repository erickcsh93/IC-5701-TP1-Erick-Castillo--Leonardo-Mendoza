...
*/
xhtml_doc : DOCTYPE HTML	{$$ = creaNodoRedEGG("xhtml_doc",$1,$2); 
					if (printN)	{imprimeNodos($$,0);}
					if (analisis)	{AnalisaAtributos($$);}};
...
br: T_TAG_OPEN T_TAG_BR atributos T_TAG_CLOSE_CLOSE {$$ = creaNodoRedAbre("abre_br","T_TAG_BR",$2,$3,"T_TAG_CLOSE_CLOSE",$4);};
...
hr: T_TAG_OPEN T_TAG_HR atributos T_TAG_CLOSE_CLOSE {$$ = creaNodoRedAbre("abre_hr","T_TAG_HR",$2,$3,"T_TAG_CLOSE_CLOSE",$4);};

img: T_TAG_OPEN T_TAG_IMG atributos T_TAG_CLOSE_CLOSE {$$ = creaNodoRedAbre("abre_img","T_TAG_IMG",$2,$3,"T_TAG_CLOSE_CLOSE",$4);};

input: T_TAG_OPEN T_TAG_INPUT atributos T_TAG_CLOSE_CLOSE {$$ = creaNodoRedAbre("abre_input","T_TAG_INPUT",$2,$3,"T_TAG_CLOSE_CLOSE",$4);};
...
link: T_TAG_OPEN T_TAG_LINK atributos T_TAG_CLOSE_CLOSE {$$ = creaNodoRedAbre("abre_link","T_TAG_LINK",$2,$3,"T_TAG_CLOSE_CLOSE",$4);};

meta: T_TAG_OPEN T_TAG_META atributos T_TAG_CLOSE_CLOSE {$$ = creaNodoRedAbre("abre_meta","T_TAG_META",$2,$3,"T_TAG_CLOSE_CLOSE",$4);};
...
atributos2:
	...
	;
atributo: T_ATR T_IGUAL T_COMILLA value T_COMILLA {$$ = creaNodoRedAtr($1,$4,getLine_inicial(),getCol_inicial ());};

value: 	|url			{$$ = creaNodoRedEG("value",$1);}
	|T_VALUE		{$$ = creaNodoRedET("value","T_VALUE",$1);}
	| value T_VALUE		{$$ = creaNodoRedEET("value",$1,"T_VALUE",$2);}
	;
url: URL {$$ = creaNodoRedET("$url","link",$1);}
